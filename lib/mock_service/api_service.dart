...
class MockApiService {
  ...
  Future<List<SongModelNew>> fetchSongDataNew() async => _getSongInfoNew();
  ...
  /// Retrieves beat metadata based on the index
  List<SongModelNew> _getSongInfoNew() {
    final List<Map<String, dynamic>> beatSongListNew = [
      {
    ...
    return beatSongListNew.map((json) => SongModelNew.fromJson(json)).toList();
  }
