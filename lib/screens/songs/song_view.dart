...
class _SongViewState extends State<SongView> {
  ...
  Widget _buildSongsList(
      SongViewModel vm, bool isConnected, BluetoothBloc bluetoothBloc) {
  ...
  Widget _buildModernSongCard(SongModel song, bool isConnected,
      BluetoothBloc bluetoothBloc, SongViewModel vm) {
    return Container(
  ...
  void _onSongTap(SongModel song, bool isConnected, BluetoothBloc bluetoothBloc,
      SongViewModel vm) async {
